/* Shared icon component for the prototype (React) */
const KNX_ICONS = {
  ...
  drag: ['circle:9,6,1','circle:15,6,1','circle:9,12,1','circle:15,12,1','circle:9,18,1','circle:15,18,1'],
  ...
  barchart: ['M3 3v18h18', 'M7 17v-5M12 17V8M17 17v-8'],
  share: ['circle:6,12,2.5', 'circle:18,6,2.5', 'circle:18,18,2.5', 'M8.2 10.8l7.6-3.6M8.2 13.2l7.6 3.6'],
  broadcast: ['circle:12,12,2', 'M7.5 7.5a6 6 0 0 0 0 9M16.5 7.5a6 6 0 0 1 0 9M4.7 4.7a10 10 0 0 0 0 14.6M19.3 4.7a10 10 0 0 1 0 14.6'],
  key: ['circle:8,15,5', 'M11.5 11.5L21 2M17 6l3 3M14 9l2 2'],
  eyeOff: ['M3 3l18 18', 'M10.6 5.1A11 11 0 0 1 12 5c6.5 0 10 7 10 7a17 17 0 0 1-3.2 4M6.3 6.3A17 17 0 0 0 2 12s3.5 7 10 7a11 11 0 0 0 4-.7', 'M9.9 9.9a3 3 0 0 0 4.2 4.2'],
  ...
  moreH: ['circle:5,12,1', 'circle:12,12,1', 'circle:19,12,1'],
  mapPin: ['M12 21s-7-5.7-7-12a7 7 0 0 1 14 0c0 6.3-7 12-7 12z', 'circle:12,9,2.5'],
  box: ['M3 7l9-4 9 4v10l-9 4-9-4z', 'M3 7l9 4 9-4M12 11v10'],
  folderOpen: ['M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2', 'M3 7l1.6 11a2 2 0 0 0 2 1.8h10.8a2 2 0 0 0 2-1.8L21 11H3z'],
  checkCircle: ['circle:12,12,9', 'M8.5 12.5l2.5 2.5 4.5-5'],
  bolt: ['M13 2L4 14h6l-1 8 9-12h-6z'],
  info: ['circle:12,12,9', 'M12 11v5M12 8h.01'],
};

function Icon({ name, size = 18, className, style }) {
  const def = KNX_ICONS[name];
  if (!def) return null;
  return (
